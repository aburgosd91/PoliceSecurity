...
//			}
			...
			if(TIPOLENGUAJE.trim().equals("ANDROID"))
			{
				...
				imports += "import com.nisira.core.database.DataBaseClass;\n";
				imports += "import android.content.ContentValues;\n";
				imports += "import android.database.Cursor;\n";
				imports += "import com.nisira.core.util.ClaveMovil;\n";
			}
			imports += "import java.util.ArrayList;\n";
...
//			imports += "import "+PAQUETEENTIDADSERVICES.trim()+".*;";
	...
	public static void main(String[] args) {
		try {
            ...
            RunGenerador rgen = new RunGenerador(RunGenerador.RAIZ_ANDROIDSTUDIO,PAQUETEBASE,RunGenerador.ANDROID);
