...
public class DordenliquidaciongastoDao extends BaseDao<Dordenliquidaciongasto> {
	...
	public Boolean insert(Dordenliquidaciongasto dordenliquidaciongasto) {
		...
		try{
			...
			initialValues.put("AFECTO", String.valueOf(dordenliquidaciongasto.getAfecto()));
			initialValues.put("INAFECTO", String.valueOf(dordenliquidaciongasto.getInafecto()));
			initialValues.put("PIMPUESTO",dordenliquidaciongasto.getPimpuesto()); 
			initialValues.put("IMPUESTO", String.valueOf(dordenliquidaciongasto.getImpuesto()));
			initialValues.put("IMPORTE", String.valueOf(dordenliquidaciongasto.getImporte()));
