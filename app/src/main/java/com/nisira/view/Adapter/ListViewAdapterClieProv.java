...
/**
 * Created by aabad on 22/08/2017.
 */

public class ListViewAdapterClieProv extends RecyclerView.Adapter<ListViewAdapterClieProv.ListaViewHolder> {
    private List<Clieprov> items;
    ...
    public ListViewAdapterClieProv(Context context,List<Clieprov> items) {
    ...
    @Override
    public ListViewAdapterClieProv.ListaViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.card_personalservicio, viewGroup, false);
        return new ListViewAdapterClieProv.ListaViewHolder(v);
    }

    @Override
    public void onBindViewHolder(ListViewAdapterClieProv.ListaViewHolder viewHolder, int i) {
        ...
        viewHolder.cargo.setText("Cargo: "+items.get(i).getIdcargo());
